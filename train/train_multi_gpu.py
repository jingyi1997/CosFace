...
def main(args):
    ...
    dataset_size = len(image_list)#452960
    ...
    with tf.Graph().as_default():
        ...
        # Build the summary operation based on the TFad collection of Summaries.
...
def train(args, sess, epoch, 
    ...
    while batch_number < args.epoch_size:
        ...
        pre = sess.run(prelogits, feed_dict=feed_dict)
        print(pre.shape)
        print('prelogits size:', )
